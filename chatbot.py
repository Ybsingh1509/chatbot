...
# Streamlit UI
st.sidebar.title("flash 2.5 Chatbot")
st.sidebar.write("Hi!I am very happy to assist you today!How can I help?")
request = st.sidebar.text_input("response")
if(request):
...
if(st.session_state.chat_started):
    ...
    for pair in st.session_state.history:
        st.header(pair['request'])   # to show prompts in a different color
